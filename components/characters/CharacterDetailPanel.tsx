  ...
  return (
    <MotionConfig reducedMotion="user">
      <motion.div
        ...
        className="dossier-card relative flex max-h-[48vh] w-full flex-col overflow-hidden rounded-t-2xl border-t border-slate-200/90 bg-surface/98 p-0 shadow-2xl outline-none backdrop-blur-xl sm:max-h-[85vh] sm:rounded-2xl sm:border dark:border-slate-800/90"
      >
        ...
        <div className="sticky top-0 z-20 flex shrink-0 items-start justify-between gap-3 border-b border-slate-200/80 bg-surface/95 px-4 py-3 backdrop-blur-md sm:p-5 dark:border-slate-800/80">
          ...
          <button
            ...
            className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-slate-200 bg-surface text-ink-dim shadow-sm transition-all hover:rotate-90 hover:border-accent/40 hover:bg-accent-soft hover:text-accent dark:border-slate-700"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
            ...
            {threads.length === 0 ? (
              ...
              >
                {threads.map(({ relationship, meta, color, otherName }) => (
                  ...
                  >
                    <span
                      className="mt-1 h-2.5 w-2.5 shrink-0 rounded-full shadow-sm ring-2 ring-white transition-transform duration-200 group-hover:scale-125 dark:ring-slate-900"
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="mt-0.5 text-xs leading-snug text-ink-dim sm:text-sm">
                        <span className="font-medium text-accent">{otherName}</span>
          ...
          <button
            ...
            className={cn(
              ...
              active
                ...
                : "border-slate-200 bg-surface text-ink-dim hover:-translate-y-0.5 hover:border-slate-300 hover:bg-surface-muted dark:border-slate-700 dark:hover:border-slate-500"
            )}
          >
            <span
