      ...
      <CardContent className="px-6 pb-8">
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <div className="space-y-1.5">
            <Label htmlFor="displayName" className="font-display text-xs font-semibold text-ink-dim">
              Display Name
            </Label>
          ...
          <div className="space-y-1.5">
            <Label htmlFor="birthday" className="font-display text-xs font-semibold text-ink-dim">
              Birthday
            </Label>
            <div className="relative">
        ...
        <div className="mt-8 pt-6 border-t border-slate-100 text-center">
          <p className="text-sm text-ink-dim">
            ...
            <Link href="/login" className="text-ink hover:underline font-bold transition-colors">
              Sign In
            </Link>
          </p>
        </div>
